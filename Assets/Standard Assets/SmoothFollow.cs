...
public class SmoothFollow : MonoBehaviour {
	...
	public float heightBuffer = 0.0f;

	public bool staticLook = false;
	...
	void LateUpdate () {
		...
		if (staticLook) {
			...
			transform.position = new Vector3(transform.position.x, currentHeight + heightBuffer, transform.position.z);
